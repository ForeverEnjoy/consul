...
func (m *mockedConfig) setupInitialTLS(t *testing.T, agentName, datacenter, token string) (*structs.CARoot, *structs.IndexedCARoots, *structs.IssuedCert, []string) {
